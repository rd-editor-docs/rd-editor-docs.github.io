...
<img src="https://cdn.discordapp.com/attachments/809186922420502568/1037989608924905543/unknown.png" alt="Zoomed-in waveform in Audacity" width="70%"/>

Once you have zoomed in far enough, click on the first part of the waveform.

<img src="https://cdn.discordapp.com/attachments/809186922420502568/1037989983140728873/unknown.png" alt="Finding offset in Audacity 2" width="70%"/>
...
![Using All8 to tap BPM](https://cdn.discordapp.com/attachments/809186922420502568/1037990571198922793/unknown.png)

In this case the BPM for the song is 160, so fill this number in in the BPM field.

![Play Song fields filled in](https://cdn.discordapp.com/attachments/809186922420502568/1037990705357930516/unknown.png)
...
If it is off at the beginning, all of the events placed from now on won't line up properly and can be a big headache to fix.

Using the metronome and skipping to the end of the song in the timeline is a good way to test that the BPM is accurate, since the song should still be in sync.
:::
