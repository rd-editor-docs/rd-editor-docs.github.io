...
<img className="no-space" src={useBaseUrl('/img/advanced-techniques/conditionals_icon.png')} alt="Icon for opening conditionals menu" width="60%"/>

**2. The 'Conditionals' button in the Actions tab.**

<img className="no-space" src={useBaseUrl('/img/advanced-techniques/conditionals_button.png')} alt="Actions tab with the 'Conditionals' button" width="30%"/>

The conditionals menu looks like this:
<img className="no-space" src={useBaseUrl('/img/advanced-techniques/conditionals_menu.png')} alt="Options that appear when opening the conditionals menu" width="50%"/>
...
<img src={useBaseUrl('/img/advanced-techniques/edit_condition.png')} alt="Edit Condition menu" width="55%"/>
...
There are **five types** of conditions:
  ...
  - **Custom** triggers the condition based on an expression.
	  - An expression can contain [variables](06-variables.mdx), operators and constants (e.g. `i1 > i2`, `i2 == 1`).
...
<img src={useBaseUrl('/img/advanced-techniques/condition_options.png')} alt="Options for duplicating or modifying conditions" width="60%"/>
...
<img src={useBaseUrl('/img/advanced-techniques/multiple_conditions.png')} alt="Example of an event with multiple conditions" width="55%"/>

Hovering over the directional sign on an event with conditions will display a helpful summary of the conditions attached.

<img src={useBaseUrl('/img/advanced-techniques/conditions_popup.png')} alt="Condition pop-up" width="45%"/>
